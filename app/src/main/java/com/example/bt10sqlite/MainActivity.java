...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount()==0){
            db.insertCa("Category 1","MSI");
            db.insertCa("Category 2","HP");
            db.insertCa("Category 3","LENOVO");
            db.insertCa("Category 4","ASUS");
            db.insertCa("Category 3","RAZOR");
        }
        cursor = db.GetData("select * from Computer");
        if (cursor.getCount()==0){
            db.insertC("MSI 01","Computer MSI 1","Category 1");
            db.insertC("MSI 02","Computer MSI 2","Category 1");
            db.insertC("MSI 03","Computer MSI 3","Category 1");
            db.insertC("MSI 04","Computer MSI 4","Category 1");
        }
